...
public class MenuService extends Service {
    ...
    private final String MENU_TITLE = "Modmenu v1.0";
    private final String MENU_AUTHOR = "Ascarre";
    private final String MENU_FOOTER = "https://t.me/ashopetech" + MENU_AUTHOR;
